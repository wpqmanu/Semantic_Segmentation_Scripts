#!/usr/bin/python
#
# Making train/val/test.txt files that are suitable for caffe training.
#
...
def main(selected_set):
    ...
    search_gt={}
    search_gt['fine']   = os.path.join( cityscapesPath , "gtFine"   , selected_set , "*" , "*_labelTrainIds.png" )
    search_gt['coarse'] = os.path.join( cityscapesPath , "gtCoarse" , selected_set, "*" , "*_labelTrainIds.png" )
    ...
    for gt_type in gt_types:
        ...
        print("Making {}_{}.txt files...".format(selected_set,gt_type))
...
if __name__ == "__main__":
    set_to_be_processed=['train','val','test']
